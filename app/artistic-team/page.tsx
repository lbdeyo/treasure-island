          ...
          {paragraphs.length > 0 ? (
            ...
            paragraphs
              .filter((paragraph) => {
                ...
                const hasProductionCredits = paragraph.content?.some(
                  (block: any) =>
                    block._type === "block" &&
                    block.children?.some(
                      (child: any) =>
              ...
              .map((paragraph, index) => (
                <div
                  key={index}
                  className="text-lg md:text-xl text-black leading-tight text-center"
                >
                  <PortableText
            ...
            <p className="text-lg md:text-xl text-black leading-tight text-center">
              Chemistry Laboratories and Shaw Entertainment Group Present
              <br />
              A Jason Neulander Production
              <br />
              TREASURE ISLAND REIMAGINED: JANE HAWKINS AND THE PIRATE'S GOLD
              <br />
              Produced by Jason Neulander and Simon Shaw
              <br />
              Executive Producers - Peggy O'Shaughnessy, Jill Wilkinson, Michael
              Breen & Stephanie Hunter
            </p>
          )}
        </div>
          ...
          <div className="relative z-20">
            <div className="space-y-8 max-w-3xl p-5">
              ...
              {paragraphs.length > 0 ? (
                ...
                paragraphs
                  .filter((paragraph) => {
                    // Filter out the specific production credits paragraph (contains multiple production keywords)
                    const fullText =
                      paragraph.content
                        ?.map(
                          (block: any) =>
                    ...
                    const isProductionCredits =
                      fullText.includes("Chemistry Laboratories") &&
                      fullText.includes("Shaw Entertainment Group") &&
                      (fullText.includes("Jason Neulander Production") ||
                        fullText.includes("Executive Producers"));

                    return !isProductionCredits;
                  })
                  .map((paragraph, index) => (
                    <div key={index}>
                    ...
                    <div className="flex flex-col md:flex-row md:gap-6 mb-8">
                      ...
                      <div>
                        ...
                        <p className="text-lg leading-relaxed">
                          Content is being loaded from Sanity Studio. Please
                          check back soon.
                        </p>
                      </div>
                    </div>
