        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="space-y-8">
                ...
                <div className="max-w-3xl">
                    <h1 className="text-4xl font-bold mb-8">EDUCATIONAL MATERIALS</h1>
                </div>
                ...
                <div className="max-w-3xl">
                    ...
                    <p className="text-lg leading-relaxed">
                        In addition to the show itself, we will provide presenters with a comprehensive study guide, modeled on an educational curriculum at the Kennedy Center.
                    </p>
                </div>
            </div>
        </div>
