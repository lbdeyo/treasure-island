...
export default async function VideoToEmbedOnYourWebsitePage() {
  const textContent = await getPageTextContent(
    "marketing-video-to-embed-on-your-website",
  );

  const pageTitle = textContent?.title || "Video to Embed on Your Website";
